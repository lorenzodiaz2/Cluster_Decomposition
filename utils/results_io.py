...
def save_results(
    ...
    df.loc[len(df)] = [
        ...
        n_clusters, similarity_matrix_time, nj_time, n_agents_per_cluster, od_pairs_per_cluster, model_times_clusters, resolution_times_clusters, clusters_status, UBs_clusters, LBs_clusters,
