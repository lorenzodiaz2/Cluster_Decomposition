    ...
    for n_quadrants in quadrant_range:
        ...
        for i in range(5):
            ...
            if not all_clusters_ok:
                save_results(env, complete_solver, cluster_solvers, i, None,None)
            else:
                ...
                if critical_resources.is_initially_feasible:
                    ...
                    save_results(env, complete_solver, cluster_solvers, i, critical_resources, None)
                    continue
                else:
                    ...
                    print("Done.")
                    save_results(env, complete_solver, cluster_solvers, i, critical_resources, final_solver)
